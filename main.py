...
from litesr import pipeline
from litesr import config
from litesr.solver_agent import sampler
from litesr.solver_agent import evaluator
import llmsr_tracker
llmsr_tracker.patch()
EQUATION = 'co2dissolution'
parser = ArgumentParser()
parser.add_argument('--port', type=int, default=None)
parser.add_argument('--use_api', type=bool, default=True)
parser.add_argument('--api_model', type=str, default="gpt-3.5-turbo")
parser.add_argument('--spec_path', type=str, default=f"./specs/specification_{EQUATION}_numpy.txt")
parser.add_argument('--log_path', type=str, default=f"./logs/{EQUATION}")
parser.add_argument('--problem_name', type=str, default=f"{EQUATION}")
